      ...
      activityIcon.addEventListener("mouseover", () => {
        ...
        switch (index) {
          case 1:
            ...
            iconInteractions[index].style.color = "var(--twitter-greenColor)";
            activityIcon.style.backgroundColor = "var(--twitter-greenHover)";
            break;
          case 2:
            icons[index].style.color = "var(--twitter-redColor)";
            iconInteractions[index].style.color = "var(--twitter-redColor)";
            activityIcon.style.backgroundColor = "var(--twitter-redHover)";
            break;
          default:
            icons[index].style.color = "var(--twitter-color)";
            iconInteractions[index].style.color = "var(--twitter-color)";
            activityIcon.style.backgroundColor = "var(--twitter-cianHover)";
            break;
        }
        activityIcon.style.transition = "background-color 200ms ease-out";
      });
    ...
    iconInteractions.forEach((iconInteraction, index) => {
      iconInteraction.addEventListener("mouseover", () => {
        switch (index) {
          case 1:
            icons[index].style.color = "var(--twitter-greenColor)";
            iconInteraction.style.color = "var(--twitter-greenColor)";
         ...
         */}
          ...
          <div className="tweet-activity">
            <div className="tweet-icon">
              ...
              <span className="icon-interaction" ref={iconInteraction1}>
                <span className="interaction">{tweetReplies!= 0 && `${tweetReplies}`}</span>
              </span>
            </div>
            ...
            <div className="tweet-icon">    
              ...
              <span className="icon-interaction" ref={iconInteraction2}>
                <span className="interaction">{tweetReposts!= 0 && `${tweetReposts}`}</span>
              </span>
            </div>
            ...
            <div className="tweet-icon">
              ...
              <span className="icon-interaction" ref={iconInteraction3}>
                <span className="interaction">{tweetLikes!= 0 && `${tweetLikes}`}</span>
              </span>
            </div>
            ...
            <div className="tweet-icon">
              ...
              <span className="icon-interaction" ref={iconInteraction4}>
                <span className="interaction">{tweetInsights!= 0 && `${tweetInsights}`}</span>
              </span>
            </div>
