...
export default function TweetReply({ tweet, token, userData }) {
    ...
    const likeDislikeTweetHandler = (e) => {
        if (isLikeActive) {
            apiLikeTweet(tweet.mainInteraction.id, token, 'DELETE');
            setTweetLikes((likes) => likes - 1);
        } else {
            apiLikeTweet(tweet.mainInteraction.id, token, 'POST');
            setTweetLikes((likes) => likes + 1);
        }
        ...
        <>
            <div className="reply" onClick={routingHandlerTweet}>
                ...
                <div className="reply-container">
                    <div
                        className="avatar-container-reply"
