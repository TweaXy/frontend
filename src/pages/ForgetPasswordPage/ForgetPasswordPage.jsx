...
const ForgetPasswordPage = () => {
  ...
  const handleUUIDSubmission = (e) => {
    ...
    forgetPasswordSchema
      ...
      .then(() => {
        fetch("http://tweaxybackend.mywire.org/api/v1/auth/forgetPassword", {
          method: "POST",
  ...
  const handleCodeSubmission = (e) => {
    ...
    const lnk = "http://tweaxybackend.mywire.org/api/v1/auth/checkResetToken"+"/"+userUUID+"/"+userCode;
  ...
  const handleChangePasswordSubmission = (e) => {
    ...
    const lnk = "http://tweaxybackend.mywire.org/api/v1/auth/resetPassword"+"/"+userUUID+"/"+userCode;
    fetch(lnk, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
